 ...
 */
final class Version20211019080514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plantes (id INT AUTO_INCREMENT NOT NULL, id_image_id INT NOT NULL, genre VARCHAR(255) NOT NULL, espece VARCHAR(255) NOT NULL, cultivar VARCHAR(255) NOT NULL, verified TINYINT(1) NOT NULL, image VARCHAR(255) NOT NULL, INDEX IDX_F3E761516D7EC9F8 (id_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
