 ...
 */
final class Version20211025113618 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plantes (id INT AUTO_INCREMENT NOT NULL, genre VARCHAR(255) NOT NULL, espece VARCHAR(255) NOT NULL, cultivar VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, nom VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
