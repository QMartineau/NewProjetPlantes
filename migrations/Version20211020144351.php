 ...
 */
final class Version20211020144351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, plantes_id INT DEFAULT NULL, avec_fleurs VARCHAR(255) DEFAULT NULL, avec_fruits VARCHAR(255) DEFAULT NULL, avec_feuilles VARCHAR(255) DEFAULT NULL, INDEX IDX_C53D045F49B7AC79 (plantes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plantes (id INT AUTO_INCREMENT NOT NULL, genre VARCHAR(255) NOT NULL, espece VARCHAR(255) NOT NULL, cultivar VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
